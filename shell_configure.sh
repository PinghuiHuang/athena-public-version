...
#python configure.py --prob collision_multipledust --ndustfluids=5 -mpi -debug -hdf5 --hdf5_path=/usr/lib/x86_64-linux-gnu/hdf5/openmpi

python configure.py --prob shock_multipledust --ndustfluids=1 -mpi -debug -hdf5 --hdf5_path=/usr/lib/x86_64-linux-gnu/hdf5/openmpi

#python configure.py --prob shock_tube --ndustfluids=0 -mpi -debug -hdf5 --hdf5_path=/usr/lib/x86_64-linux-gnu/hdf5/openmpi
