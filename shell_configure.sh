...
#python configure.py --prob=dust_collision --eos=isothermal --ndustfluids=1 --nghost=2 -mpi -debug -hdf5 --hdf5_path=${hdf5path} -h5double
...
#python configure.py --prob=nsh_dust --ndustfluids=3 --eos=isothermal -mpi -hdf5 --hdf5_path=${hdf5path} -debug -h5double

#python configure.py -shear --prob=dust_streaming --ndustfluids=1 --eos=isothermal -mpi -hdf5 --hdf5_path=${hdf5path} -debug -h5double
