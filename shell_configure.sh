...
#python configure.py --prob kh --ndustfluids=1 --nghost=2 -mpi -debug -hdf5 --hdf5_path=${hdf5path} -h5double

#python configure.py -shear --prob=ssheet --flux=hlle --eos=isothermal --ndustfluids=1 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double

#python configure.py --prob=visc_dustfluids -mpi -debug --ndustfluids=1 -hdf5 --hdf5_path=${hdf5path} -h5double

#python configure.py --prob=hb3 -shear -b --eos=isothermal -mpi -debug -hdf5 --hdf5_path=${hdf5path} -h5double

#python configure.py --prob=hb3_dustfluids -shear -b -debug --eos=isothermal --ndustfluids=1 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double

#python configure.py -shear --prob=nsh_dust --ndustfluids=1 --eos=isothermal -mpi -hdf5 --hdf5_path=${hdf5path} -debug -h5double
