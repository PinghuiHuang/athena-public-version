...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          ...
          Real delta_gas_m1_b = 2.0* TWO_3RD * delta_m1_implicit_p(0);
          Real delta_gas_m2_b = 2.0* TWO_3RD * delta_m2_implicit_p(0);
          Real delta_gas_m3_b = 2.0* TWO_3RD * delta_m3_implicit_p(0);
          ...
          for (int n=1; n<=NDUSTFLUIDS; ++n){
            ...
            Real delta_dust_m1_b = 2.0 * TWO_3RD * delta_m1_implicit_p(n);
            Real delta_dust_m2_b = 2.0 * TWO_3RD * delta_m2_implicit_p(n);
            Real delta_dust_m3_b = 2.0 * TWO_3RD * delta_m3_implicit_p(n);
