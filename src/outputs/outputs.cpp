...
void OutputType::LoadOutputData(MeshBlock *pmb) {
  ...
  if (NDUSTFLUIDS > 0) {
    ...
    for (int n=0; n<NDUSTFLUIDS; n++) {
      ...
      std::string dust_den_str  = "dust_" + std::to_string(index) + "_den";
      ...
      if (output_params.variable.compare(dust_den_str) == 0 ||
          output_params.variable.compare("cons") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_mom1_str) == 0 ||
          output_params.variable.compare("cons") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_mom2_str) == 0 ||
          output_params.variable.compare("cons") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_mom3_str) == 0 ||
          output_params.variable.compare("cons") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_rho_str) == 0 ||
          output_params.variable.compare("prim") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_vel1_str) == 0 ||
          output_params.variable.compare("prim") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_vel2_str) == 0 ||
          output_params.variable.compare("prim") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
      ...
      if (output_params.variable.compare(dust_vel3_str) == 0 ||
          output_params.variable.compare("prim") == 0) {
        pod = new OutputData;
        pod->type = "SCALARS";
