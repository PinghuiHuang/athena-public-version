...
#pragma omp declare simd simdlen(SIMD_WIDTH) uniform(this,df_cons,n,k,j) linear(i)
...
#pragma omp declare simd simdlen(SIMD_WIDTH) uniform(this)
  ...
  Real SoundSpeed_DustFluids(const Real prim_df[(4*NDUSTFLUIDS)], const Real nu_dust, const Real eddy_time);
...
#pragma omp declare simd simdlen(SIMD_WIDTH) uniform(this)
  ...
  Real SoundSpeed_DustFluids(const Real[]) {return 0.0;}
  Real FastMagnetosonicSpeed(const Real[], const Real) {return 0.0;}
  void ApplyPrimitiveConservedFloors(
...
#pragma omp declare simd simdlen(SIMD_WIDTH) uniform(this)
 ...
 private:
  ...
  Real dustfluids_floor_;                // dimensionless concentration floor
