...
void HydroSourceTerms::AddHydroSourceTerms(const Real time, const Real dt, const AthenaArray<Real> *flux,
  ...
  if (UserSourceTerm != nullptr) {
    UserSourceTerm(pmb, time, dt, prim, prim_df, bcc, cons, cons_df);
  }
