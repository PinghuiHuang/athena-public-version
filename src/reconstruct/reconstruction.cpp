    ...
    correct_err{pin->GetOrAddBoolean("time", "correct_err", false)}, pmy_block_{pmb}
{
  ...
  if (NDUSTFLUIDS > 0){
    ...
    scr1_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
    scr2_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
    scr3_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
    scr4_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
  }
  ...
  if ((xorder == 3) || (xorder == 4)) {
    ...
    if (NDUSTFLUIDS > 0){
      scr03_i_df_.NewAthenaArray(nc1);
      scr04_i_df_.NewAthenaArray(nc1);
      scr05_i_df_.NewAthenaArray(nc1);
      scr06_i_df_.NewAthenaArray(nc1);
      scr07_i_df_.NewAthenaArray(nc1);
      scr08_i_df_.NewAthenaArray(nc1);
      scr09_i_df_.NewAthenaArray(nc1);
      scr10_i_df_.NewAthenaArray(nc1);
      scr11_i_df_.NewAthenaArray(nc1);
      scr12_i_df_.NewAthenaArray(nc1);
      scr13_i_df_.NewAthenaArray(nc1);
      scr14_i_df_.NewAthenaArray(nc1);

      scr5_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
      scr6_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
      scr7_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
      scr8_ni_df_.NewAthenaArray(4*NDUSTFLUIDS, nc1);
    }
